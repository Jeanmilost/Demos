...
//---------------------------------------------------------------------------
bool QR_FileTools::GetDirContent(const std::string& dir, QR_StringTools::IStrings& content,
        bool fullNames)
{
    // open directory
...
//---------------------------------------------------------------------------
bool QR_FileTools::GetDirContent(const std::wstring& dir, QR_StringTools::IwStrings& content,
        bool fullNames)
{
    // open directory
